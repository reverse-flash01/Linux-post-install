...
apt install code unp pulseeffects typora default-jre vnstat micro zram-config deja-dup unzip unrar wget plank curl git neofetch nautilus-script-manager fish build-essential powertop htop tlp python3-pip gnome-tweaks tmux vlc plymouth-themes -y
